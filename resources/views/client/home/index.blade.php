...
<!-- Banner Section Two -->
	...
	<section class="about-section-two">
		<div class="circle-layer" style="background-image:url(../../client/images/icons/icon-1.png)"></div>
		<div class="dotted-layer" style="background-image:url(../../client/images/icons/dotted-pattern.png)"></div>
		<div class="auto-container">
	...
	<section class="services-section-two">
		<div class="long-arrow" style="background-image: url(../../client/images/icons/long-arrow-4.png)"></div>
		<div class="plus-icons" style="background-image:url(../../client/images/icons/icon-3.png)"></div>
		<div class="auto-container">
			<!-- Sec Title -->
	...
	<section class="gallery-section-two">
		<div class="long-arrow" style="background-image: url(../../client/images/icons/long-arrow-4.png)"></div>
		<div class="pattern-icon" style="background-image: url(../../client/images/icons/icon-4.png)"></div>
		<div class="auto-container">
			<!-- Sec Title -->
			<div class="sec-title centered">
		...
		<div class="auto-container">
			<div class="row clearfix">
				...
				<div class="feature-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
						<div class="icon">
							<img src="../../client/images/resource/feature-1.png" alt="" />
						</div>
				...
				<div class="feature-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
						<div class="icon">
							<img src="../../client/images/resource/feature-2.png" alt="" />
						</div>
				...
				<div class="feature-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow fadeInRight" data-wow-delay="300ms" data-wow-duration="1500ms">
						<div class="icon">
							<img src="../../client/images/resource/feature-3.png" alt="" />
						</div>
	...
	<section class="testimonial-section">
		<div class="long-arrow" style="background-image: url(../../client/images/icons/long-arrow-1.png)"></div>
		<div class="circle-layer" style="background-image:url(../../client/images/icons/icon-1.png)"></div>
		<div class="plus-icons" style="background-image:url(../../client/images/icons/icon-3.png)"></div>
		<div class="side-pattern" style="background-image:url(../../client/images/background/pattern-1.png)"></div>
		<div class="auto-container">
			<!-- Sec Title -->
			<div class="sec-title centered">
	...
	<!-- Contact Section -->
	<section class="contact-section" style="background-image:url(../../client/images/background/1.jpg)">
		<div class="auto-container">
			<div class="row clearfix">
				...
				<div class="column col-lg-6 col-md-12 col-sm-12">
					<div class="inner-column">
						<div class="long-arrow" style="background-image: url(../../client/images/icons/long-arrow-3.png)"></div>
						<!-- Sec Title -->
