...
<link href="../../client/css/color-switcher-design.css" rel="stylesheet">
<!-- Color Themes -->
<link id="theme-color-file" href="../../client/color-themes/default-theme.css" rel="stylesheet">
...
<div class="page-wrapper">
        	...
        	<div class="auto-container">
            	<div class="inner-container clearfix">
					...
					<div class="outer-box clearfix">
						<!-- Quote Btn -->
						<div class="btn-box">
							<a href="tel:+800-019-4900" class="contact-btn theme-btn"><span class=""></span>+989128509671</a>
						</div>
					</div>
					...
					<nav class="main-menu navbar-expand-md">
						...
						<div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
							<ul class="navigation clearfix" dir="rtl">
								...
								<li class="dropdown"><a href="/blog">بلاگ</a></li>
    ...
    <footer class="main-footer style-two">
		<div class="patern-icon" style="background-image: url(../../client/images/icons/icon-4.png)"></div>
    	<div class="auto-container">
        	<!--Widgets Section-->
...
<div class="color-palate">
    ...
    <div class="various-color clearfix">
        <div class="colors-list">
            <span class="palate default-color active" data-theme-file="../../client/color-themes/default-theme.css"></span>
            <span class="palate green-color" data-theme-file="../../client/color-themes/green-theme.css"></span>
            <span class="palate blue-color" data-theme-file="../../client/color-themes/blue-theme.css"></span>
            <span class="palate orange-color" data-theme-file="../../client/color-themes/orange-theme.css"></span>
            <span class="palate purple-color" data-theme-file="../../client/color-themes/purple-theme.css"></span>
            <span class="palate teal-color" data-theme-file="../../client/color-themes/teal-theme.css"></span>
            <span class="palate brown-color" data-theme-file="../../client/color-themes/brown-theme.css"></span>
            <span class="palate redd-color" data-theme-file="../../client/color-themes/redd-color.css"></span>
        </div>
    </div>
